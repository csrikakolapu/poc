...
var UATableComponent = (function () {
    ...
    UATableComponent.prototype.getTableData = function () {
        ...
        this.FetchFileService.getFileData(this.fileName).subscribe(function (response) {
            _this.tableData = response.fileContentMappedData;
        });
